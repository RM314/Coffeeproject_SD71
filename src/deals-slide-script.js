...
const prevBtn = document.querySelector('.deal-button-prev');
const nextBtn = document.querySelector('.deal-button-next');
const dots = document.querySelectorAll('.deal-dot');
const sliderContainer = document.querySelector('.deals-slider-container');
